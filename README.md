...
** Be warned that, generally, determinant and inversion do not work properly for integers as a consequence of division happening in these calculations. Use float or an equivalent in these cases.
